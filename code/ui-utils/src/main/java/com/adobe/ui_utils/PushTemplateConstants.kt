...
object PushTemplateConstants {
    ...
    const val DEFAULT_DELETE_ICON_NAME = "cross"
    ...
    object DefaultValues {
        ...
        const val ICON_TEMPLATE_MIN_IMAGE_COUNT = 3
        const val ICON_TEMPLATE_MAX_IMAGE_COUNT = 5
