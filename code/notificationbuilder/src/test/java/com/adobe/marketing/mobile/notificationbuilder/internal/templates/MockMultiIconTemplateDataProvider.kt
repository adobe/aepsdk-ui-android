...
object MockMultiIconTemplateDataProvider {
    ...
    fun getMockedDataMapWithForMultiIcon(): MutableMap<String, String> {
        return mutableMapOf(
            ...
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.TEMPLATE_TYPE to PushTemplateType.MULTI_ICON.value,
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.BODY to "",
            ...
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.MULTI_ICON_CLOSE_BUTTON to "delete",
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.MULTI_ICON_ITEMS to MOCK_MULTI_ICON_ITEM_PAYLOAD,
        )
    }
}
