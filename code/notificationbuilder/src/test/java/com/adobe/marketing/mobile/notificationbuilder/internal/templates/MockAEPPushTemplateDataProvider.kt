...
object MockAEPPushTemplateDataProvider {
    ...
    fun getMockedAEPDataMapWithAllKeys(): MutableMap<String, String> {
        return mutableMapOf(
            ...
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.ACTION_TYPE to com.adobe.ui_utils.PushTemplateConstants.ActionType.NONE.name,
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.ACTION_BUTTONS to MOCKED_ACTION_BUTTON_DATA,
            ...
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.REMIND_LATER_TEXT to MOCK_REMIND_LATER_TEXT,
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.REMIND_LATER_TIMESTAMP to MOCK_REMIND_LATER_TIME,
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.REMIND_LATER_DURATION to MOCK_REMIND_LATER_DURATION,
            ...
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.ZERO_BEZEL_COLLAPSED_STYLE to "img"
        )
    }
    ...
    fun getMockedAEPBundleWithAllKeys(): Bundle {
        ...
        mockBundle.putString(
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.ACTION_TYPE,
            com.adobe.ui_utils.PushTemplateConstants.ActionType.NONE.name
        )
        mockBundle.putString(
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.ACTION_BUTTONS,
        ...
        mockBundle.putString(
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.REMIND_LATER_TEXT,
            MOCK_REMIND_LATER_TEXT
        )
        mockBundle.putString(
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.REMIND_LATER_TIMESTAMP,
            MOCK_REMIND_LATER_TIME
        )
        mockBundle.putString(
            com.adobe.ui_utils.PushTemplateConstants.PushPayloadKeys.REMIND_LATER_DURATION,
